if oSystem.currentWindow="expedition"
{
	...
	if array_length(expLog)<onscreenMaxText
	{
		...
		{
			draw_set_colour(oSystem.colors[expLog[i][1]]) 
			draw_text(157,28+10*i,expLog[i][0])
		}
	}
	else
	{
		...
		{
			draw_set_colour(oSystem.colors[expLog[i][1]]) 
			draw_text(157,28+10*i,expLog[textlogStart + i][0])
		}
